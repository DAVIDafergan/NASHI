    ...
    if (loading) return (
        <div className="min-h-screen flex items-center justify-center bg-slate-50">
            <div className="text-center space-y-4">
                ...
                <p className="font-black text-rose-500">טוען שאלון...</p>
            </div>
        </div>
    );
        ...
        <div className="min-h-screen bg-slate-50 py-12 px-4 md:px-8 text-right font-sans" dir="rtl">
            <div className="max-w-3xl mx-auto bg-white rounded-[4rem] shadow-2xl overflow-hidden border border-rose-100">
                ...
                <div className="bg-gradient-to-l from-rose-500 to-pink-600 p-12 text-white space-y-4 relative overflow-hidden">
                    ...
                    <p className="text-rose-100 text-lg font-bold relative z-10">שלום {profile?.name}, נשמח שתשתפי אותנו בסיפור שלך כדי שנוכל להאיר את הקהילה.</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="p-10 md:p-16 space-y-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="relative group mx-auto w-48 h-48">
                            ...
                            <div className="w-48 h-48 bg-slate-50 rounded-[3.5rem] border-4 border-dashed border-slate-200 flex flex-col items-center justify-center text-slate-400 overflow-hidden relative group-hover:bg-slate-100 transition-all">
                                {profile?.image ? (
                    ...
                    <div className="pt-6">
                        ...
                        <p className="text-center text-slate-400 text-sm font-bold mt-6">בלחיצה על שליחה, את מאשרת את פרסום התשובות והתמונה באתר.</p>
                    </div>
                </form>
            </div>
        </div>
